...
together:
    ...
    Jellyfin.Plugin.Watchlist/PluginServiceRegistrator.cs:86:            Plugin.Instance!.DataFolderPath,
...
moved to 86, and it said 60, 57 and 47 before that. The reason is the same every time
